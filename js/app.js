$(document).ready(function() {
    ...
    for (var i=0;i<projectsArray.length;i++) {
        ...
        newCardA.append($('<img class="waves-effect waves-light" src="'+projectsArray[i].Pic+'" alt="Portfolio Pic" style="border-radius: 25px;">')).append($('<p class="ctr-txt white-text">'+projectsArray[i].Name+'</p>'));
