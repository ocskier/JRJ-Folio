$(document).ready(function() {
    ...
    for (var i=0;i<projectsArray.length;i++) {
        ...
        var newCardA = $('<a class="carousel-item waves-effect waves-circle waves-light" href="'+projectsArray[i].Url+'" target="blank" style="width:310px;"></a>');
        newCardA.append($('<img src="'+projectsArray[i].Pic+'" alt="Portfolio Pic" style="border-radius: 25px;"overflow:initial>')).append($('<p class="ctr-txt white-text">'+projectsArray[i].Name+'</p>'));
