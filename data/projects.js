...
const Proj2 = new Project(
  ...
  "assets/images/railway-station-619082_1280.jpg",
  "Train Station",
  "https://github.com/ocskier/Train-Station"
);
// const Proj3=new Project("https://ocskier.github.io/BLS-Website/","assets/images/christine-mendoza-527612-unsplash.jpg","Brightleaf","https://github.com/ocskier/BLS-Website");
const Proj4 = new Project(
  "https://ocskier.github.io/Trivia-Game/",
  "assets/images/question-mark-1872665_1280.jpg",
  "Trivia Game",
  "https://github.com/ocskier/Trivia-Game"
);
const Proj5 = new Project(
  "https://ocskier.github.io/Star-Wars-Battle/",
  "assets/images/main-thumb-t-1785517-200-boztfctkwxbzmfjwurneimbimaluhaxk.jpeg",
  "Star Wars Battle",
  "https://github.com/ocskier/Star-Wars-Battle"
);
const Proj6 = new Project(
  "https://ocskier.github.io/Tithe/",
  "assets/images/tithe-favicon.1.png",
  "Tithe App",
  "https://github.com/ocskier/Tithe"
);
const Proj7 = new Project(
  "https://ocskier.github.io/Api-Ajax/",
  "assets/images/window-615427_1920.jpg",
  "Api Demo",
...
const Proj9 = new Project(
  ...
  "assets/images/love-logo-hi.png",
  "Match Maker",
  "https://github.com/ocskier/Match-Maker"
);
// const Proj10=new Project("https://intense-wildwood-45271.herokuapp.com/","assets/images/fabio-alves-773406-unsplash.jpg","Burger App","https://github.com/ocskier/Burger-App");
const Proj11 = new Project(
  "https://fierce-basin-24175.herokuapp.com/",
  "assets/images/fabio-alves-773406-unsplash.jpg",
  "Serialize Burger",
  "https://github.com/ocskier/sequelizedBurger"
);
const Proj12 = new Project(
  "https://aristotle-app.herokuapp.com/",
  "assets/images/jeshoots-com-436787-unsplash.jpg",
  "Aristotle",
  "https://github.com/ocskier/Aristotle"
);
// const Proj13=new Project("http://mongoscraps.herokuapp.com/","assets/images/hannah_gibbs_1067876.jpg","Mongo Scraper","https://github.com/ocskier/Mongo-Scraper");
const Proj14 = new Project(
  "https://search-react-app.herokuapp.com/",
  "assets/images/hannah_gibbs_1067876.jpg",
  "NPR-Music-React",
  "https://github.com/ocskier/NPR-Music-Search-React"
);
const Proj15 = new Project(
  "https://wishlist-p3t6-app.herokuapp.com/",
  "assets/images/Screenshot_Proj.jpg",
  "WishList",
